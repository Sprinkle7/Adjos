        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
		        ...
		        <nav id="mainmenu" class="mainmenu col-lg-6">
					<ul>
						<li class="logo-wrapper"><a href="index.php"><img src="img/mine/logo.png" width="100" height="100"><!-- <h3>JOADS Finder</h3>--></li>
						<li class="active">
        ...
        <div class="container ser" style="width:80%;">
        	...
        	<div class="row search">
        		<div class="col-lg-12">
        			...
        			<div class="col-lg-9">
        				<div class="col-lg-12">
        					<h2>University Of Agriculture Peshawar</h2>
        				</div>
        				<div class="col-lg-12">
							<table class="table table-responsive">
								<tr>
									...
									<td>
										<h4 class="right">Computer Science</h4>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<h4 class="right">12-july-2014</h4>
									</td>
								</tr>
								<tr>
									<td>
