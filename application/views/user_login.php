...
<html>
  ...
  <body id="login" style="margin-top:0px;" class="color7">
    <div class="container signin">
      <form class="form-signin" action="<?php echo base_url();?>login/usersign" id="shadow" method="post" style="background:rgba(255,255,255,0.1);">
        <h2 class="form-signin-heading">User Login</h2>
        <input type="text" class="input-block-level"  name="username" placeholder="Email address">
        <input type="password" class="input-block-level" name="password"  placeholder="Password">
        <input class="btn color4" type="submit" name="loged" value="Sign In">
